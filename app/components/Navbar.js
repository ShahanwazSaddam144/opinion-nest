...
const Navbar = () => {
  ...
  const NavButton = ({ label, path, delay = "0ms" }) => (
    <button
      ...
      className="relative group text-gray-600 font-medium text-sm transition-colors duration-200 hover:text-blue-600 animate-fade-up opacity-0 [animation-fill-mode:forwards] whitespace-nowrap"
    >
      {label}
  ...
  return (
    <>
      <style>{`
        ...
        .icon-pop {
          animation: iconPop 0.55s cubic-bezier(0.34,1.56,0.64,1) 0.05s both;
        }
        ...
        .drawer-animate {
          animation: drawerIn 0.35s cubic-bezier(0.16,1,0.3,1) both;
        }
            ...
            <div className="flex flex-col items-center text-center gap-4">
              ...
              <div>
                <h2 className="text-[17px] font-bold text-gray-800 tracking-tight">
                  Sign out of Opinion-Nest?
                </h2>

                <p className="text-sm text-gray-400 mt-1 leading-relaxed">
                  Your analysis session will end. You can always sign back in.
                </p>
              </div>
      ...
      <nav className="fixed top-0 left-0 w-full nav-animate flex items-center justify-between px-4 sm:px-6 py-4 bg-white border-b border-gray-200 shadow-[0_1px_16px_rgba(37,99,235,0.06)] z-50">
        ...
        >
          <div className="icon-pop w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center font-bold text-white relative overflow-hidden brand-icon-shimmer shrink-0">
            O
          </div>

          <div className="min-w-0">
            <h1 className="truncate animate-fade-up opacity-0 [animation-fill-mode:forwards] [animation-delay:150ms] text-[15px] sm:text-[17px] font-bold text-gray-800 tracking-tight">
              Opinion-Nest
            </h1>

            <p className="truncate animate-fade-up opacity-0 [animation-fill-mode:forwards] [animation-delay:220ms] text-[10px] sm:text-[11px] text-gray-400 tracking-widest uppercase">
              ButtNetworks
            </p>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-6 xl:gap-8">
          ...
          <NavButton label="AI Insights" path="#ai-insights" delay="400ms" />
          <NavButton label="Reports" path="#reports" delay="450ms" />

          <a href="/Opinion-NestMobile.apk" download>
          <button
            className="animate-fade-up opacity-0 [animation-fill-mode:forwards] [animation-delay:500ms] px-4 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-semibold hover:scale-105 transition-all duration-200 shadow-md"
          >
            Download App
          </button>
          </a>
          ...
          {user ? (
            <div className="animate-fade-up opacity-0 [animation-fill-mode:forwards] [animation-delay:550ms] relative z-50">
              <div
            ...
            <button
              ...
              className="animate-fade-up opacity-0 [animation-fill-mode:forwards] [animation-delay:550ms] text-sm text-blue-600 font-semibold hover:underline underline-offset-2 transition"
            >
              Login
            </button>
          )}
        ...
        <button
          ...
          className="lg:hidden text-2xl text-gray-600 hover:text-blue-600 transition-colors duration-200"
        >
          ☰
        </button>
      </nav>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-[85%] max-w-[320px] bg-white border-l border-gray-100 z-50 shadow-[-8px_0_40px_rgba(0,0,0,0.08)] transform transition-transform duration-300 ${
        ...
        <div className="p-6 flex flex-col gap-6 h-full overflow-y-auto">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center font-bold text-white relative overflow-hidden brand-icon-shimmer shrink-0">
                O
              </div>

              <div className="min-w-0">
                <h1 className="truncate text-[17px] font-bold text-gray-800 tracking-tight">
                  Opinion-Nest
                </h1>

                <p className="truncate text-[11px] text-gray-400 tracking-widest uppercase">
                  ButtNetworks
                </p>
              </div>
            </div>
            ...
            <button
              onClick={() => setMenuOpen(false)}
              className="text-xl text-gray-400 hover:text-red-500 transition-colors duration-200 hover:rotate-90 transform"
            >
              ✕
            </button>
          </div>
          ...
          <a href="/Opinion-NestMobile.apk" download>
          <button
            className="w-full py-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-semibold hover:scale-[1.02] transition-all duration-200 shadow-md"
          >
            Download App
          </button>
          </a>
          ...
          {[
            ...
            { label: "Chat History", path: "/chatHistory" },
